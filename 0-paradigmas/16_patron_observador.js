...
((c)=> {
  ...
  //Click representa al sujeto Player (pub)
  //clickHandler es la función observadora (sub) este controlador suscribe y cancela la observación, adicionalmente dispara los eventos para visiualizar las notificaciones de los mismos
  //Log clase auxiliar que recoge y muestra los resultados
